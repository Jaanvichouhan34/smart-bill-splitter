  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 backdrop-blur-sm shadow-xl space-y-4">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-800">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="bg-slate-950 border border-slate-700 text-slate-200 text-xs rounded-lg px-2 py-1 focus:outline-none focus:border-indigo-500 font-mono"
          >
      ...
      <div className="space-y-2.5 text-xs sm:text-sm">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-28 text-right bg-slate-950/80 border border-slate-800 focus:border-indigo-500 rounded-lg px-2.5 py-1 text-slate-100 font-mono font-semibold focus:outline-none focus:ring-1 focus:ring-indigo-500"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-28 text-right bg-slate-950/80 border border-slate-800 focus:border-indigo-500 rounded-lg px-2.5 py-1 text-slate-300 font-mono focus:outline-none focus:ring-1 focus:ring-indigo-500"
            />
          </div>
        </div>
        ...
        {/* Service Charge */}
        <div className="flex items-center justify-between gap-3">
          <span className="text-slate-400">Service Charge / Packaging</span>
          <div className="flex items-center gap-1">
            <span className="text-slate-500 font-mono text-xs">{currencySymbol}</span>
            <input
              type="number"
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1">
            <span className="text-emerald-500 font-mono text-xs">- {currencySymbol}</span>
            <input
              type="number"
              step="0.01"
              min="0"
              ...
              placeholder="0.00"
              className="w-28 text-right bg-slate-950/80 border border-slate-800 focus:border-emerald-500 rounded-lg px-2.5 py-1 text-emerald-300 font-mono focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
          </div>
        </div>
        ...
        <div className="pt-2 border-t border-slate-800">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <span className="text-[11px] text-slate-400">Final bill amount</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-indigo-400 font-mono font-bold text-sm">{currencySymbol}</span>
              <input
                type="number"
                step="0.01"
                min="0"
                ...
                placeholder="0.00"
                className="w-32 text-right bg-indigo-950/40 border border-indigo-500/50 focus:border-indigo-400 rounded-lg px-3 py-1.5 text-white font-mono font-bold text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 shadow-inner"
              />
            </div>
          </div>
        </div>
      ...
      <div className="pt-2 border-t border-slate-800/80">
        {!sanity.isTotalValid ? (
          <div className="p-2.5 rounded-xl bg-amber-950/40 border border-amber-800/60 text-amber-200 text-xs space-y-1.5">
      ...
      <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800/80 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-300 font-medium">Overall AI Accuracy</span>
        </div>
