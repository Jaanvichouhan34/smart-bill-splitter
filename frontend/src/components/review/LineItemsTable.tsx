...
export const LineItemsTable: React.FC = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Table Container */}
      <div className="border border-slate-800 rounded-2xl bg-slate-900/50 backdrop-blur-sm overflow-hidden shadow-lg">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-xs sm:text-sm">
            <thead>
              <tr className="border-b border-slate-800 bg-slate-950/60 text-slate-400 font-medium text-[11px] uppercase tracking-wider">
              ...
              {billData.items.length === 0 ? (
                ...
                billData.items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Index */}
                      <td className="py-2.5 px-3 sm:px-4 text-center text-slate-500 font-mono text-xs">
                        {index + 1}
                      </td>
                      ...
                      <td className="py-2 px-3 sm:px-4">
                        <input
                          ...
                          className="w-full bg-transparent hover:bg-slate-800/60 focus:bg-slate-900 border border-transparent hover:border-slate-700 focus:border-indigo-500 rounded-lg px-2 py-1 text-slate-100 placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all font-medium"
                        />
                      </td>
                      ...
                      <td className="py-2 px-2 sm:px-3 text-center">
                        <input
                          ...
                          placeholder="1"
                          className="w-16 mx-auto text-center bg-transparent hover:bg-slate-800/60 focus:bg-slate-900 border border-transparent hover:border-slate-700 focus:border-indigo-500 rounded-lg px-1.5 py-1 text-slate-100 font-mono focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
                        />
                      </td>
                      ...
                      <td className="py-2 px-2 sm:px-3 text-right">
                        <div className="flex items-center justify-end">
                          <span className="text-slate-500 text-xs mr-0.5">{currencySymbol}</span>
                          <input
                            type="number"
                            step="0.01"
                            min="0"
                            ...
                            placeholder="0.00"
                            className="w-20 text-right bg-transparent hover:bg-slate-800/60 focus:bg-slate-900 border border-transparent hover:border-slate-700 focus:border-indigo-500 rounded-lg px-1.5 py-1 text-slate-300 font-mono focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
                          />
                        </div>
                      </td>
                      ...
                      <td className="py-2 px-3 sm:px-4 text-right">
                        <div className="flex items-center justify-end">
                          <span className="text-indigo-400 font-medium text-xs mr-0.5">{currencySymbol}</span>
                          <input
                            type="number"
                            step="0.01"
                            min="0"
                            ...
                            placeholder="0.00"
                            className="w-24 text-right bg-transparent hover:bg-slate-800/60 focus:bg-slate-900 border border-transparent hover:border-slate-700 focus:border-indigo-500 rounded-lg px-2 py-1 text-slate-100 font-semibold font-mono focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
                          />
                        </div>
                      </td>
                      ...
                      <td className="py-2 px-2 sm:px-3 text-center">
                        <button
                          ...
                          className="p-1.5 rounded-lg text-slate-500 hover:text-rose-400 hover:bg-rose-950/40 opacity-60 group-hover:opacity-100 transition-all cursor-pointer"
                          title="Remove item"
                        >
