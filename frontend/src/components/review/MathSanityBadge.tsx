...
export const MathSanityBadge: React.FC = () => {
  ...
  if (sanity.isSubtotalValid) {
    return (
      <div className="flex items-center justify-between flex-wrap gap-2 px-4 py-2.5 rounded-xl bg-emerald-950/40 border border-emerald-800/60 text-emerald-300 shadow-sm animate-in fade-in">
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-4 py-3 rounded-xl bg-amber-950/50 border border-amber-800/70 text-amber-200 shadow-md animate-in fade-in">
