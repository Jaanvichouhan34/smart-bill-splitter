    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 space-y-8">
      ...
      <div className="text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20 text-xs font-semibold uppercase tracking-wider">
          <Sparkles className="w-3.5 h-3.5" /> Smart Receipt Extraction
        </div>
      ...
      {status === 'error' && errorMessage && (
        <div className="bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800/80 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="p-2 rounded-xl bg-rose-100 dark:bg-rose-900/50 text-rose-600 dark:text-rose-400 flex-shrink-0">
              <AlertCircle className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-sm font-semibold text-rose-700 dark:text-rose-200">Extraction Error</h4>
              <p className="text-xs text-rose-600 dark:text-rose-300/90 mt-0.5 max-w-xl">{errorMessage}</p>
            </div>
          </div>
          <button
            onClick={retryExtraction}
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-semibold shadow-md shadow-rose-600/30 transition-all flex-shrink-0 cursor-pointer"
          >
      ...
      <div className="bg-slate-100/60 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 backdrop-blur-sm shadow-xl dark:shadow-2xl">
        {receiptImageUrl ? (
          <ImagePreview />
        ) : (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
        <div className="p-4 rounded-2xl bg-slate-100/60 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/50 flex items-start gap-3">
          <div className="p-2 rounded-lg bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex-shrink-0">
            <Zap className="w-4 h-4" />
          </div>
          <div>
            <h5 className="text-xs font-semibold text-slate-800 dark:text-slate-200">Instant Vision OCR</h5>
        ...
        <div className="p-4 rounded-2xl bg-slate-100/60 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/50 flex items-start gap-3">
          ...
          <div>
            <h5 className="text-xs font-semibold text-slate-800 dark:text-slate-200">Math Sanity Check</h5>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
        ...
        <div className="p-4 rounded-2xl bg-slate-100/60 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/50 flex items-start gap-3">
          ...
          <div>
            <h5 className="text-xs font-semibold text-slate-800 dark:text-slate-200">Group Split Ready</h5>
            <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
